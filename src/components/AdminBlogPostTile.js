...
const AdminBlogPostTile = ({
    ...
    return (
        <div className="bg-white rounded-xl w-[350px] shadow-lg overflow-hidden flex flex-col items-center transition-transform duration-300 ease-in-out hover:-translate-y-1">
